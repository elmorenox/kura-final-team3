...
resource "aws_iam_role" "redis-eks-role_west" {
  name = "redis-eks-role-west"
...
resource "aws_iam_role_policy_attachment" "redis-eks-AmazonEKSClusterPolicy" {
  ...
  role       = aws_iam_role.redis-eks-role_west.name
}

resource "aws_eks_cluster" "redis-eks-cluster" {
  name     = "redis-eks-cluster-west"
  role_arn = aws_iam_role.redis-eks-role_west.arn
...
resource "aws_iam_role" "nodes_west" {
  name = "eks-node-group-nodes-west"
...
resource "aws_iam_role_policy_attachment" "nodes-AmazonEKSWorkerNodePolicy" {
  ...
  role       = aws_iam_role.nodes_west.name
}
...
resource "aws_eks_node_group" "private-node" {
  ...
  node_role_arn   = aws_iam_role.nodes_west.arn
...
output "cluster_role_arn" {
  ...
  value       = aws_iam_role.redis-eks-role_west.arn
}

output "node_role_arn" {
  description = "ARN of the IAM role for the EKS node group"
  value       = aws_iam_role.nodes_west.arn
}